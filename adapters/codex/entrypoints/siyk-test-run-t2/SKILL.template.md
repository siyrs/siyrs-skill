...
description: 执行固定、可机器选择的 T2 冒烟测试集. Use explicitly for /siyk-test-run-t2.
---
...
3. Load the root command registry and the command Markdown registered for `/siyk-test-run-t2`.
