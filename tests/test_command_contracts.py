...
class CommandContractTests(unittest.TestCase):
    def test_manifest_routes_all_commands(self):
        ...
        for command in ("/siyk-test-full", "/siyk-test-new", "/siyk-git-sync"):
            self.assertIn(command, text)

    def test_command_docs_have_completion_language(self):
        for rel in ("commands/test-full.md", "commands/test-new.md", "commands/git-sync.md"):
    ...
    def test_bundled_helpers_use_skill_dir_placeholder(self):
        for rel in ("SKILL.md", "commands/test-full.md", "commands/test-new.md", "commands/git-sync.md"):
